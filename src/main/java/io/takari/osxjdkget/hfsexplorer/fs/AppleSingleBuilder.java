...
package io.takari.osxjdkget.hfsexplorer.fs;
...
import io.takari.osxjdkget.hfsexplorer.types.applesingle.AppleSingleHeader;
import io.takari.osxjdkget.hfsexplorer.types.applesingle.AttributeEntry;
import io.takari.osxjdkget.hfsexplorer.types.applesingle.AttributeHeader;
import io.takari.osxjdkget.hfsexplorer.types.applesingle.EntryDescriptor;
import io.takari.osxjdkget.util.Util;
import io.takari.osxjdkget.util.Util.Pair;
...
public class AppleSingleBuilder {
  ...
  public static enum FileSystem {
    MACOS("Macintosh"), MACOS_X("Mac OS X"), PRODOS("ProDOS"), MS_DOS("MS-DOS"), UNIS("Unix"), VMS("VAX VMS");
  ...
  public static enum EntryType {
    DATA_FORK(EntryDescriptor.ENTRY_ID_DATA), RESOURCE_FORK(EntryDescriptor.ENTRY_ID_RESOURCE), REAL_NAME(EntryDescriptor.ENTRY_ID_REALNAME), COMMENT(EntryDescriptor.ENTRY_ID_COMMENT), ICON_BW(
      EntryDescriptor.ENTRY_ID_ICONBW), ICON_COLOR(EntryDescriptor.ENTRY_ID_ICONCOLOR), FILE_INFO(EntryDescriptor.ENTRY_ID_UNUSED), FINDER_INFO(EntryDescriptor.ENTRY_ID_FINDERINFO);
