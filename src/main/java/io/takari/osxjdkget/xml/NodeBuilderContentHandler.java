...
package io.takari.osxjdkget.xml;
...
public class NodeBuilderContentHandler extends XMLContentHandler {
  ...
  @Override
  public void emptyElement(String name, List<io.takari.osxjdkget.xml.Attribute> attributes) {
    try {
  ...
  @Override
  public void startElement(String name, List<io.takari.osxjdkget.xml.Attribute> attributes) {
    try {
      Attribute2[] attrs = new Attribute2[attributes.size()];
      //for(int i = 0; i < attributes.length; ++i) {
      int i = 0;
      for (io.takari.osxjdkget.xml.Attribute a : attributes) {
