...
import io.takari.osxjdkget.dmg.udif.UDIFDetector;
import io.takari.osxjdkget.dmg.udif.UDIFRandomAccessStream;
import io.takari.osxjdkget.hfsexplorer.IOUtil;
import io.takari.osxjdkget.hfsexplorer.Java7Util;
import io.takari.osxjdkget.hfsexplorer.fs.AppleSingleBuilder;
import io.takari.osxjdkget.hfsexplorer.fs.AppleSingleBuilder.AppleSingleVersion;
import io.takari.osxjdkget.hfsexplorer.fs.AppleSingleBuilder.FileSystem;
import io.takari.osxjdkget.hfsexplorer.fs.AppleSingleBuilder.FileType;
import io.takari.osxjdkget.io.ReadableFileStream;
...
import io.takari.osxjdkget.storage.fs.FSFile;
...
import io.takari.osxjdkget.storage.fs.FSLink;
import io.takari.osxjdkget.storage.fs.FileSystemDetector;
import io.takari.osxjdkget.storage.fs.FileSystemHandler;
import io.takari.osxjdkget.storage.fs.FileSystemHandlerFactory;
import io.takari.osxjdkget.storage.fs.FileSystemMajorType;
import io.takari.osxjdkget.storage.fs.FileSystemHandlerFactory.CustomAttribute;
import io.takari.osxjdkget.storage.io.DataLocator;
import io.takari.osxjdkget.storage.io.ReadableStreamDataLocator;
import io.takari.osxjdkget.storage.io.SubDataLocator;
import io.takari.osxjdkget.storage.ps.Partition;
import io.takari.osxjdkget.storage.ps.PartitionSystemDetector;
...
import io.takari.osxjdkget.storage.ps.PartitionSystemType;
...
public class UnHFS {
   ...
   * @param verbose
   * @throws io.takari.osxjdkget.io.RuntimeIOException
   */
  private void unhfs(
