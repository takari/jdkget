...
import io.takari.osxjdkget.hfs.plus.HFSPlusVolume;
...
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSAttributesIndexNode;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSAttributesKey;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSAttributesLeafNode;
...
import io.takari.osxjdkget.hfs.types.hfsplus.HFSPlusAttributesKey;
  ...
  private void listAttributeRecords(final CommonBTNode curNode,
    ...
    final CommonHFSAttributesKey searchKey =
      CommonHFSAttributesKey.create(new HFSPlusAttributesKey(
        ((CommonHFSCatalogNodeID.HFSPlusImplementation) nodeID).getHFSCatalogNodeID(), 0, new char[0]));
    final CommonHFSAttributesKey endKey =
      CommonHFSAttributesKey.create(new HFSPlusAttributesKey(
        ((CommonHFSCatalogNodeID.HFSPlusImplementation) nodeID.add(1)).getHFSCatalogNodeID(), 0, new char[0]));
