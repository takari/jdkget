...
package io.takari.osxjdkget.hfs;
...
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTIndexRecord;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTKeyedNode;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTNode;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTNodeDescriptor;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSCatalogFileThreadRecord;
...
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSCatalogFolderThread;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSCatalogFolderThreadRecord;
...
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSCatalogThread;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSCatalogThreadRecord;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSVolumeHeader;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTNodeDescriptor.NodeType;
    ...
    if (leafThreadRec != null) {
      ...
      if (leafThreadRec instanceof CommonHFSCatalogThreadRecord) {
        final CommonHFSCatalogThread thread =
          ((CommonHFSCatalogThreadRecord) leafThreadRec).getData();
