...
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTKey;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTKeyedNode;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTKeyedRecord;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonBTLeafRecord;
...
public abstract class BTreeFile<K extends CommonBTKey<K>, L extends CommonBTLeafRecord<K>> {
  ...
  protected abstract CommonBTKeyedNode<? extends CommonBTIndexRecord<K>> createIndexNode(byte[] nodeData, int offset, int nodeSize);
