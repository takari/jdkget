...
public class HFSPlusAttributesData extends HFSPlusAttributesLeafRecordData
  ...
  public HFSPlusAttributesData(byte[] data, int offset) {
    super(data, offset);
    this.reserved = io.takari.osxjdkget.util.Util.readLongBE(data, offset + 4);
    this.attrSize = io.takari.osxjdkget.util.Util.readIntBE(data, offset + 12);

    long unsignedAttrSize = io.takari.osxjdkget.util.Util.unsign(this.attrSize);
  ...
  public final long[] getReserved() {
    return io.takari.osxjdkget.util.Util.unsign(getRawReserved());
  }

  /** size of attribute data in bytes */
  public final long getAttrSize() {
    return io.takari.osxjdkget.util.Util.unsign(getRawAttrSize());
  }
  ...
  public final byte[] getAttrData() {
    ...
    return io.takari.osxjdkget.util.Util.createCopy(attrData1);
  }
  ...
  public final int[] getRawReserved() {
    return io.takari.osxjdkget.util.Util.readIntArrayBE(io.takari.osxjdkget.util.Util.toByteArrayBE(this.reserved));
  }
  ...
  public byte[] getBytes() {
    ...
    io.takari.osxjdkget.util.Util.arrayPutBE(result, offset, this.reserved);
    offset += 8;
    io.takari.osxjdkget.util.Util.arrayPutBE(result, offset, this.attrSize);
    offset += 4;
