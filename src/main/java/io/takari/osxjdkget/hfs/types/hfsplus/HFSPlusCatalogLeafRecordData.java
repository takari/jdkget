...
public abstract class HFSPlusCatalogLeafRecordData implements PrintableStruct, StructElements {
  ...
  public String getRecordTypeAsString() {
    ...
    if (recordType == RECORD_TYPE_FOLDER)
      return "kHFSPlusFolderRecord";
    else if (recordType == RECORD_TYPE_FILE)
      return "kHFSPlusFileRecord";
    else if (recordType == RECORD_TYPE_FOLDER_THREAD)
      return "kHFSPlusFolderThreadRecord";
    else if (recordType == RECORD_TYPE_FILE_THREAD)
