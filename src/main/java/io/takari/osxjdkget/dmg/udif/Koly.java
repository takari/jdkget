...
public class Koly {
  ...
  public int getFourCC() {
    return io.takari.osxjdkget.util.Util.readIntBE(fourCC);
  }

  public byte[] getUnknown1() {
    return io.takari.osxjdkget.util.Util.createCopy(unknown1);
  }

  public long getPlistBegin1() {
    return io.takari.osxjdkget.util.Util.readLongBE(plistBegin1);
  }

  public long getPlistEndSometimes() {
    return io.takari.osxjdkget.util.Util.readLongBE(plistEndSometimes);
  }

  public long getUnknown2() {
    return io.takari.osxjdkget.util.Util.readLongBE(unknown2);
  }

  public long getUnknown3() {
    return io.takari.osxjdkget.util.Util.readLongBE(unknown3);
  }

  public long getUnknown4() {
    return io.takari.osxjdkget.util.Util.readLongBE(unknown4);
  }

  public long getUnknown5() {
    return io.takari.osxjdkget.util.Util.readLongBE(unknown5);
  }

  public long getPossibleChecksumType() {
    return io.takari.osxjdkget.util.Util.readLongBE(possibleChecksumType);
  }

  public int getUnknown6() {
    return io.takari.osxjdkget.util.Util.readIntBE(unknown6);
  }

  public int getPossibleUnitSize() {
    return io.takari.osxjdkget.util.Util.readIntBE(possibleUnitSize);
  }

  public byte[] getUnknown7() {
    return io.takari.osxjdkget.util.Util.createCopy(unknown7);
  }

  public long getPlistBegin2() {
    return io.takari.osxjdkget.util.Util.readLongBE(plistBegin2);
  }

  public long getPlistSize() {
    return io.takari.osxjdkget.util.Util.readLongBE(plistSize);
  }

  public byte[] getUnknown8() {
    return io.takari.osxjdkget.util.Util.createCopy(unknown8);
  }

  public int getChecksumAlgorithm() {
    return io.takari.osxjdkget.util.Util.readIntBE(checksumAlgorithm);
  }

  public int getChecksumSize() {
    return io.takari.osxjdkget.util.Util.readIntBE(checksumSize);
  }

  public byte[] getChecksumData() {
    return io.takari.osxjdkget.util.Util.createCopy(checksumData);
  }
  ...
  public void printFields(PrintStream ps, String prefix) {
    ps.println(prefix + " fourCC: \"" + io.takari.osxjdkget.util.Util.toASCIIString(getFourCC()) + "\"");
    ps.println(prefix + " unknown1: 0x" + io.takari.osxjdkget.util.Util.byteArrayToHexString(getUnknown1()));
    ...
    ps.println(prefix + " unknown7: 0x" + io.takari.osxjdkget.util.Util.byteArrayToHexString(getUnknown7()));
    ps.println(prefix + " plistBegin2: " + getPlistBegin2());
    ps.println(prefix + " plistSize: " + getPlistSize());
    ps.println(prefix + " unknown8: 0x" + io.takari.osxjdkget.util.Util.byteArrayToHexString(getUnknown8()));
    ...
    ps.println(prefix + " checksumData: 0x" + io.takari.osxjdkget.util.Util.byteArrayToHexString(checksumData, 0, checksumSize)); // checksumSize is in bits
    int i;
    for (i = 0; i + 4 <= (checksumData.length - checksumSize); i += 4)
      ps.println(prefix + " trailing data[" + i + "]: 0x " + io.takari.osxjdkget.util.Util.byteArrayToHexString(checksumData, checksumSize + i, 4));
    int bytesLeft = i + 4 - (checksumData.length - checksumSize);
    if (bytesLeft > 0 && bytesLeft < 4) {
      System.err.println("bytes left: " + bytesLeft);
      ps.println(prefix + " trailing data[" + i + "]: 0x " + io.takari.osxjdkget.util.Util.byteArrayToHexString(checksumData, checksumSize + i, (i + 4) - (checksumData.length - checksumSize)));
    }
  }
