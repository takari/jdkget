...
public class OsxJdkGetter {
  ...
  public OsxJdkGetter(String version, File outputDirectory) {
  ...
  public static class Builder {
    ...
    public OsxJdkGetter build() {
      return new OsxJdkGetter(version, outputDirectory);
    }
