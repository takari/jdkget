...
package io.takari.osxjdkget.storage.ps;

import io.takari.osxjdkget.storage.fs.FileSystemMajorType;
import io.takari.osxjdkget.storage.ps.container.ContainerType;
...
public enum PartitionType {
  EMPTY(ContentType.OTHER), FAT12(ContentType.FILE_SYSTEM, FileSystemMajorType.FAT12), FAT16(ContentType.FILE_SYSTEM, FileSystemMajorType.FAT16), FAT32(ContentType.FILE_SYSTEM,
    FileSystemMajorType.FAT32), DOS_EXTENDED(ContentType.PARTITION_SYSTEM, PartitionSystemType.DOS_EXTENDED), NT_OS2_IFS(ContentType.CONTAINER, ContainerType.NT_OS2_IFS),
  ...
  APPLE_PRODOS(ContentType.FILE_SYSTEM, FileSystemMajorType.APPLE_PRODOS), LINUX_LVM(ContentType.PARTITION_SYSTEM), LINUX_SWAP(ContentType.OTHER), LINUX_NATIVE(ContentType.CONTAINER,
    ContainerType.LINUX_NATIVE), GPT_PROTECTIVE(ContentType.PARTITION_SYSTEM), EFI_SYSTEM(ContentType.FILE_SYSTEM), SPECIAL(ContentType.OTHER), UNKNOWN(ContentType.OTHER);
