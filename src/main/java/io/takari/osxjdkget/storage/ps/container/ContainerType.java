...
package io.takari.osxjdkget.storage.ps.container;
...
import io.takari.osxjdkget.storage.ps.container.hfs.HFSContainerHandlerFactory;

/**
 * @author <a href="http://www.catacombae.org/" target="_top">Erik Larsson</a>
 */
public enum ContainerType {
  NT_OS2_IFS, APPLE_HFS(HFSContainerHandlerFactory.class), APPLE_UNIX_SVR2, LINUX_NATIVE;
