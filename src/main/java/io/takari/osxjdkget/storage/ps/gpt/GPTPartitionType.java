...
public enum GPTPartitionType {
  ...
  PARTITION_TYPE_UNUSED_ENTRY(0x0000000000000000L, 0x0000000000000000L, PartitionType.EMPTY), PARTITION_TYPE_EFI_SYSTEM(0x28732AC11FF8D211L, 0xBA4B00A0C93EC93BL,
    PartitionType.EFI_SYSTEM), PARTITION_TYPE_MICROSOFT_RESERVED(0x16E3C9E35C0BB84DL, 0x817DF92DF00215AEL, PartitionType.SPECIAL), PARTITION_TYPE_PRIMARY_PARTITION(0xA2A0D0EBE5B93344L,
      0x87C068B6B72699C7L, PartitionType.NT_OS2_IFS), PARTITION_TYPE_LDM_METADATA(0xAAC808588F7EE042L, 0x85D2E1E90434CFB3L, PartitionType.SPECIAL), PARTITION_TYPE_LDM_DATA(0xA0609BAF3114624FL,
        0xBC683311714A69ADL, PartitionType.SPECIAL), PARTITION_TYPE_APPLE_HFS(0x005346480000AA11L, 0xAA1100306543ECACL, PartitionType.APPLE_HFS_CONTAINER), PARTITION_TYPE_APPLE_BOOT(
          0x746F6F420000AA11L, 0xAA1100306543ECACL, PartitionType.SPECIAL), PARTITION_TYPE_LINUX_SWAP(0x6DFD5706ABA4C443L, 0x84E50933C84B4F4FL, PartitionType.LINUX_SWAP), UNKNOWN_PARTITION_TYPE; // Returned when no known type can be matched
