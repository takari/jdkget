...
import io.takari.osxjdkget.storage.ps.PartitionType;
...
public enum MBRPartitionType {
  ...
  UNUSED((byte) 0x00, PartitionType.EMPTY), FAT12((byte) 0x01, PartitionType.FAT12), FAT16_SMALL((byte) 0x04, PartitionType.FAT16), DOS_EXTENDED((byte) 0x05,
    PartitionType.DOS_EXTENDED), FAT16_LARGE((byte) 0x06, PartitionType.FAT16), NT_INSTALLABLE_FS((byte) 0x07, PartitionType.NT_OS2_IFS), FAT32((byte) 0x0B,
      PartitionType.FAT32), FAT32_INT13HX((byte) 0x0C, PartitionType.FAT32), FAT16_LARGE_INT13HX((byte) 0x0E, PartitionType.FAT16), DOS_EXTENDED_INT13HX((byte) 0x0F,
        PartitionType.DOS_EXTENDED), EISA_OR_OEM((byte) 0x12, PartitionType.SPECIAL), DYNAMIC_VOLUME((byte) 0x42, PartitionType.SPECIAL), PM_HIBERNATION((byte) 0x84,
          PartitionType.SPECIAL), NT_MULTIDISK_FAT16((byte) 0x86, PartitionType.SPECIAL), NT_MULTIDISK_NTFS((byte) 0x87, PartitionType.SPECIAL), LAPTOP_HIBERNATION((byte) 0xA0,
            PartitionType.SPECIAL), DELL_OEM((byte) 0xDE, PartitionType.SPECIAL), IBM_OEM((byte) 0xFE, PartitionType.SPECIAL), GPT_PROTECTIVE((byte) 0xEE,
              PartitionType.GPT_PROTECTIVE), EFI_SYSTEM_ON_MBR((byte) 0xEF, PartitionType.EFI_SYSTEM), APPLE_UFS((byte) 0xA8, PartitionType.APPLE_UFS), // UFS in NeXT format (only slightly different)
              APPLE_HFS((byte) 0xAF, PartitionType.APPLE_HFS_CONTAINER), // Used for HFS, HFS+ and HFSX
              LINUX_SWAP((byte) 0x82, PartitionType.LINUX_SWAP), LINUX_NATIVE((byte) 0x83, PartitionType.LINUX_NATIVE), // Used for reiserfs, ext2, ext3 and many more
              UNKNOWN;
