...
package io.takari.osxjdkget.storage.fs;
...
import io.takari.osxjdkget.storage.fs.hfs.HFSFileSystemHandlerFactory;
import io.takari.osxjdkget.storage.fs.hfsplus.HFSPlusFileSystemHandlerFactory;
import io.takari.osxjdkget.storage.fs.hfsx.HFSXFileSystemHandlerFactory;
...
public enum FileSystemMajorType {
  APPLE_MFS, APPLE_HFS(HFSFileSystemHandlerFactory.class), APPLE_HFS_PLUS(HFSPlusFileSystemHandlerFactory.class), APPLE_HFSX(
    HFSXFileSystemHandlerFactory.class), APPLE_UFS, APPLE_PRODOS, FAT12, FAT16, FAT32, EXFAT, NTFS, HPFS, EXT3, REISERFS, REISER4, XFS, JFS, ZFS, UNKNOWN;
