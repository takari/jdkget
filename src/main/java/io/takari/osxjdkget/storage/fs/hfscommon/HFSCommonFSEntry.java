...
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSCatalogAttributes;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSCatalogNodeID;
import io.takari.osxjdkget.hfs.types.hfscommon.CommonHFSFinderInfo;
import io.takari.osxjdkget.storage.fs.BasicFSEntry;
    ...
    if (attributeForkList == null) {
      ...
      if (attributesFile != null) {
        LinkedList<Pair<char[], LinkedList<CommonHFSAttributesLeafRecord>>> attributeBucketList =
          new LinkedList<Pair<char[], LinkedList<CommonHFSAttributesLeafRecord>>>();

        for (CommonHFSAttributesLeafRecord attributeRecord : attributesFile.listAttributeRecords(getCatalogNodeID())) {
          ...
          if (!attributeBucketList.isEmpty() &&
            ...
            p = new Pair<char[], LinkedList<CommonHFSAttributesLeafRecord>>(
        ...
        for (Pair<char[], LinkedList<CommonHFSAttributesLeafRecord>> p : attributeBucketList) {
          ...
          tmpAttributeForkList.add(new HFSCommonAttributeFork(this,
            recordList.toArray(
              new CommonHFSAttributesLeafRecord[recordList.size()])));
        }
      }
