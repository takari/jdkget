...
package io.takari.osxjdkget.storage.io.win32;
...
public class ReadableWin32FileStream implements ReadableRandomAccessStream {
  ...
  private enum ArchitectureIdentifier {
    ...
    I386("i386"), AMD64("amd64"), IA64("ia64"), POWERPC("ppc32"), POWERPC64("ppc64"), SPARC("sparc32"), SPARC64("sparc64"), MIPS("mips32"), MIPS64("mips64"), ALPHA("alpha"), UNKNOWN;
