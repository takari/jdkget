...
public class HFSPlusAttributesData extends HFSPlusAttributesLeafRecordData
  ...
  public HFSPlusAttributesData(byte[] data, int offset) {
    super(data, offset);
    this.reserved = io.takari.jdkget.osx.util.Util.readLongBE(data, offset + 4);
    this.attrSize = io.takari.jdkget.osx.util.Util.readIntBE(data, offset + 12);

    long unsignedAttrSize = io.takari.jdkget.osx.util.Util.unsign(this.attrSize);
  ...
  public final long[] getReserved() {
    return io.takari.jdkget.osx.util.Util.unsign(getRawReserved());
  }

  /** size of attribute data in bytes */
  public final long getAttrSize() {
    return io.takari.jdkget.osx.util.Util.unsign(getRawAttrSize());
  }
  ...
  public final byte[] getAttrData() {
    ...
    return io.takari.jdkget.osx.util.Util.createCopy(attrData1);
  }
  ...
  public final int[] getRawReserved() {
    return io.takari.jdkget.osx.util.Util.readIntArrayBE(io.takari.jdkget.osx.util.Util.toByteArrayBE(this.reserved));
  }
  ...
  public byte[] getBytes() {
    ...
    io.takari.jdkget.osx.util.Util.arrayPutBE(result, offset, this.reserved);
    offset += 8;
    io.takari.jdkget.osx.util.Util.arrayPutBE(result, offset, this.attrSize);
    offset += 4;
