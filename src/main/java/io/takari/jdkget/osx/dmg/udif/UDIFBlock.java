...
public class UDIFBlock implements Comparable<UDIFBlock> {
  ...
  public UDIFBlock(byte[] data, int offset, long outOffsetComp, long inOffsetComp) {
    this(io.takari.jdkget.osx.util.Util.readIntBE(data, offset + 0),
      io.takari.jdkget.osx.util.Util.readIntBE(data, offset + 4),
      io.takari.jdkget.osx.util.Util.readLongBE(data, offset + 8) * 0x200,
      io.takari.jdkget.osx.util.Util.readLongBE(data, offset + 16) * 0x200,
      io.takari.jdkget.osx.util.Util.readLongBE(data, offset + 24),
      io.takari.jdkget.osx.util.Util.readLongBE(data, offset + 32),
      outOffsetComp,
      inOffsetComp);
  }
  ...
  public static long peekInOffset(byte[] data, int offset) {
    return io.takari.jdkget.osx.util.Util.readLongBE(data, offset + 24);
  }
  ...
  public static long peekInSize(byte[] data, int offset) {
    return io.takari.jdkget.osx.util.Util.readLongBE(data, offset + 32);
  }
