...
public interface Readable {
   ...
   * @throws io.takari.jdkget.osx.io.RuntimeIOException if the stream doesn't
   ...
   * 
   * @param data the array where the output data should be stored.
   * @throws io.takari.jdkget.osx.io.RuntimeIOException if the stream doesn't contain enough data to
